...
#include "../GameObject/SceneFinalBack2.h"
#include "../GameObject/SceneFinalBack1.h"
...
bool CSceneFinal::Init()
{
	...
	GetSceneResource()->LoadSound("BGM", "SceneFinalBGM", true, "Maple/Back/FuryOfTheWatcher.mp3");
	...
	GetSceneResource()->SoundStop("SceneFinalBGM");
	GetSceneResource()->SoundPlay("SceneFinalBGM");
	...
	GetCamera()->SetWorldResolution(1200.f, 762.f);  // 전체 크기
	...
	*/
	// 메인씬에 오브젝트(배경)을 추가한다.
	CSceneFinalBack1* back1 = CreateObject<CSceneFinalBack1>("SceneFinalBack1");
	CreateObject<CSceneFinalBack2>("SceneFinalBack2");


	// 씬에 바닥 선을 추가한다.
	CGround* ground = CreateObject<CGround>("Ground1");
	ground->SetInfo(Vector2(0.f, 620.f), Vector2(1200.f, 620.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground2");
	ground->SetInfo(Vector2(1.f, 266.f), Vector2(192.f, 266.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground3");
	ground->SetInfo(Vector2(98.f, 298.f), Vector2(339.f, 298.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground4");
	ground->SetInfo(Vector2(851.f, 194.f), Vector2(985.f, 194.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground5");
	ground->SetInfo(Vector2(947.f, 251.f), Vector2(1076.f, 251.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground5");
	ground->SetInfo(Vector2(834.f, 292.f), Vector2(965.f, 292.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground6");
	ground->SetInfo(Vector2(950.f, 371.f), Vector2(1074.f, 371.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground7");
	ground->SetInfo(Vector2(1024.f, 308.f), Vector2(1200.f, 308.f));
	ground->SetType(ELineType::Ground);


	// 벽 선을 추가한다.
	CWall* wall = CreateObject<CWall>("Wall1");
	wall->SetInfo(Vector2(1.f, 1.f), Vector2(1.f, 762.f));
	wall->SetType(ELineType::Wall);

	wall = CreateObject<CWall>("Wall2");
	wall->SetInfo(Vector2(1200.f, 1.f), Vector2(1200.f, 762.f));
	wall->SetType(ELineType::Wall);
	...
	ladder->SetInfo(Vector2(122.f, 297.f), Vector2(122.f, 533.f));
	ladder->SetType(ELineType::Ladder);

	ladder = CreateObject<CLadder>("Ladder2");
	ladder->SetInfo(Vector2(1015.f, 367.f), Vector2(1015.f, 550.f));
	ladder->SetType(ELineType::Ladder);
	...
	// Scene1로 가는 포탈을 추가한다.
	CPortal* SceneFinalPortal1 = CreateObject<CPortal>("Portal_SceneFinalToScene1");
	SceneFinalPortal1->SetPos(1150.f, 620.f);


	return true;
}

void CSceneFinal::CreateAnimationSequence_Effect()
{
	// 플레이어 왼쪽->오른쪽 히트 이펙트 
...
void CSceneFinal::CreateAnimationSequence()
{
	// 플레이어 오른쪽 멈춤
...
void CSceneFinal::CreateAnimationSequence1()
{
	std::vector<std::wstring>	vecFileName;
...
void CSceneFinal::CreateAnimationSequence2()
{
	// 발록 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CSceneFinal::CreateAnimationSequence3()
{
	// 타우로마시스 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CSceneFinal::CreateAnimationSequence4()
{
	// 타우로스피어 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CSceneFinal::CreateAnimationSequence5()
{
	// 와일드카고 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CSceneFinal::CreateAnimationSequence6()
{
	// 포탈
	std::vector<std::wstring> vecFileName;
...
void CSceneFinal::CreateAnimationBallogKing()
{
	// 발록 몸체 정지
	std::vector<std::wstring> vecFileName;
	...
	for (int i = 0; i < 12; ++i)
	{
		...
		wsprintf(fileName, TEXT("Monster/Ballog_King/Body/stand.%d.bmp"), i);

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("BodyStand"))
	{
		GetSceneResource()->CreateAnimationSequence("BodyStand",
			"BodyStand", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("BodyStand", 0.f, 0.f,
			828.f, 564.f);
		GetSceneResource()->AddAnimationFrame("BodyStand", 0.f, 0.f,
			828.f, 560.f);
		GetSceneResource()->AddAnimationFrame("BodyStand", 0.f, 0.f,
		...
		GetSceneResource()->AddAnimationFramePivot("BodyStand", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyStand", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyStand", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyStand", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyStand", 0.5f, 0.5f);
		...
		GetSceneResource()->SetColorKey("BodyStand", 255, 0, 255);
	}
	...
	for (int i = 0; i < 12; ++i)
	{
		...
		wsprintf(fileName, TEXT("Monster/Ballog_King/Body/Stand/stand.%d.bmp"), i);
	...
	for (int i = 0; i < 48; ++i)
	{
		...
		wsprintf(fileName, TEXT("Monster/Ballog_King/Body/Die/die.%d.bmp"), i);

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("BodyDie"))
	{
		GetSceneResource()->CreateAnimationSequence("BodyDie",
			"BodyDie", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("BodyDie", 0.f, 0.f,
			944.f, 752.f);
		GetSceneResource()->AddAnimationFrame("BodyDie", 0.f, 0.f,
			944.f, 752.f);
		GetSceneResource()->AddAnimationFrame("BodyDie", 0.f, 0.f,
...
//
		...
		GetSceneResource()->AddAnimationFramePivot("BodyDie", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyDie", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyDie", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyDie", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("BodyDie", 0.5f, 0.5f);
		...
		GetSceneResource()->SetColorKey("BodyDie", 255, 0, 255);
	}
}
