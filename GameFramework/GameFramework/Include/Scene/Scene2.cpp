...
#include "../GameObject/Scene2Back2.h"
#include "../GameObject/Scene2Back1.h"
...
bool CScene2::Init()
{
	...
	GetSceneResource()->LoadSound("BGM", "Scene2BGM", true, "Maple/Back/WhiteNight.mp3");
	...
	GetSceneResource()->SoundStop("Scene1BGM");
	...
	*/
	// 메인씬에 오브젝트(배경)을 추가한다.
	CScene2Back1* back1 = CreateObject<CScene2Back1>("Scene2Back1");
	CreateObject<CScene2Back2>("Scene2Back2");


	// 씬에 바닥 선을 추가한다.
	CGround* ground = CreateObject<CGround>("Ground1");
	ground->SetInfo(Vector2(0.f, 853.f), Vector2(1246.f, 853.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground2");
	ground->SetInfo(Vector2(1232.f, 795.f), Vector2(2050.f, 795.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground3");
	ground->SetInfo(Vector2(1.f, 520.f), Vector2(170.f, 520.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground4");
	ground->SetInfo(Vector2(300.f, 549.f), Vector2(474.f, 549.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground5");
	ground->SetInfo(Vector2(90.f, 550.f), Vector2(273.f, 550.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground5");
	ground->SetInfo(Vector2(1687.f, 493.f), Vector2(1810.f, 493.f));
	ground->SetType(ELineType::Ground);
	...
	wall->SetInfo(Vector2(2047.f, 166.f), Vector2(2047.f, 861.f));
	wall->SetType(ELineType::Wall);

	wall = CreateObject<CWall>("Wall3");
	wall->SetInfo(Vector2(1234.f, 795.f), Vector2(1234.f, 916.f));
	wall->SetType(ELineType::Wall);
	...
	ladder->SetInfo(Vector2(203.f, 546.f), Vector2(201.f, 777.f));
	ladder->SetType(ELineType::Ladder);

	ladder = CreateObject<CLadder>("Ladder2");
	ladder->SetInfo(Vector2(1748.f, 491.f), Vector2(1745.f, 710.f));
	ladder->SetType(ELineType::Ladder);
	...
	// Scene1로 가는 포탈을 추가한다.
	CPortal* Scene2Portal1 = CreateObject<CPortal>("Portal_Scene2ToScene1");
	Scene2Portal1->SetPos(75.f, 529.f);

	// Scene3로 가는 포탈을 추가한다.
	CPortal* Scene2Portal2 = CreateObject<CPortal>("Portal_Scene2ToScene3");
	Scene2Portal2->SetPos(1960.f, 800.f);
	

	// 와일드 카고를 추가한다
	CWildCargo* WildCargo = CreateObject<CWildCargo>("WildCargo");
	WildCargo->SetPos(Vector2(200,700));
	WildCargo->SetFallStartY(800.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo1");
	WildCargo->SetPos(Vector2(350, 700));
	WildCargo->SetFallStartY(800.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo2");
	WildCargo->SetPos(Vector2(500, 700));
	WildCargo->SetFallStartY(800.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo3");
	WildCargo->SetPos(Vector2(650, 700));
	WildCargo->SetFallStartY(800.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo4");
	WildCargo->SetPos(Vector2(800, 700));
	WildCargo->SetFallStartY(800.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo5");
	WildCargo->SetPos(Vector2(950, 700));
	WildCargo->SetFallStartY(800.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo6");
	WildCargo->SetPos(Vector2(1000, 700));
	WildCargo->SetFallStartY(800.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo7");
	WildCargo->SetPos(Vector2(1600, 700));
	WildCargo->SetFallStartY(770.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo8");
	WildCargo->SetPos(Vector2(1700, 700));
	WildCargo->SetFallStartY(770.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo9");
	WildCargo->SetPos(Vector2(1750, 700));
	WildCargo->SetFallStartY(770.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo10");
	WildCargo->SetPos(Vector2(1800, 700));
	WildCargo->SetFallStartY(770.f);

	WildCargo = CreateObject<CWildCargo>("WildCargo11");
	WildCargo->SetPos(Vector2(1850, 700));
	WildCargo->SetFallStartY(770.f);

	return true;
}

void CScene2::CreateAnimationSequence_Effect()
{
	// 플레이어 왼쪽->오른쪽 히트 이펙트 
...
void CScene2::CreateAnimationSequence1()
{
	std::vector<std::wstring>	vecFileName;
...
void CScene2::CreateAnimationSequence2()
{
	// 발록 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene2::CreateAnimationSequence3()
{
	// 타우로마시스 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene2::CreateAnimationSequence4()
{
	// 타우로스피어 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene2::CreateAnimationSequence5()
{
	// 와일드카고 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene2::CreateAnimationSequence6()
{
	// 포탈
	std::vector<std::wstring> vecFileName;
