...
#include "../GameObject/Scene3Back2.h"
#include "../GameObject/Scene3Back1.h"
...
bool CScene3::Init()
{
	...
	// GetSceneResource()->SoundPlay("Scene2BGM");
	...
	GetCamera()->SetWorldResolution(2052.f, 1044.f);  // 전체 크기
	...
	*/
	// 메인씬에 오브젝트(배경)을 추가한다.
	CScene3Back1* back1 = CreateObject<CScene3Back1>("Scene3Back1");
	CreateObject<CScene3Back2>("Scene3Back2");


	// 씬에 바닥 선을 추가한다.
	CGround* ground = CreateObject<CGround>("Ground1");
	ground->SetInfo(Vector2(1.f, 809.f), Vector2(2140.f, 809.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground2");
	ground->SetInfo(Vector2(1.f, 499.f), Vector2(172.f, 499.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground3");
	ground->SetInfo(Vector2(406.f, 496.f), Vector2(577.f, 496.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground4");
	ground->SetInfo(Vector2(1226.f, 504.f), Vector2(1392.f, 504.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground5");
	ground->SetInfo(Vector2(1530.f, 506.f), Vector2(1694.f, 506.f));
	ground->SetType(ELineType::Ground);


	// 벽 선을 추가한다.
	CWall* wall = CreateObject<CWall>("Wall1");
	wall->SetInfo(Vector2(1.f, 1.f), Vector2(1.f, 916.f));
	wall->SetType(ELineType::Wall);

	wall = CreateObject<CWall>("Wall2");
	wall->SetInfo(Vector2(2045.f, 206.f), Vector2(2045.f, 968.f));
	wall->SetType(ELineType::Wall);


	// 밧줄과 사다리를 추가한다.
	CLadder* ladder = CreateObject<CLadder>("Ladder1");
	ladder->SetInfo(Vector2(99.f, 494.f), Vector2(99.f, 697.f));
	ladder->SetType(ELineType::Ladder);

	ladder = CreateObject<CLadder>("Ladder2");
	ladder->SetInfo(Vector2(533.f, 490.f), Vector2(531.f, 723.f));
	ladder->SetType(ELineType::Ladder);

	ladder = CreateObject<CLadder>("Ladder3");
	ladder->SetInfo(Vector2(1634.f, 500.f), Vector2(1634.f, 706.f));
	ladder->SetType(ELineType::Ladder);
	...
	// Scene2로 가는 포탈을 추가한다.
	CPortal* Scene3Portal1 = CreateObject<CPortal>("Portal_Scene3ToScene2");
	Scene3Portal1->SetPos(75.f, 500.f);

	// Scene4 ( MainScene )로 가는 포탈을 추가한다.
	CPortal* Scene3Portal2 = CreateObject<CPortal>("Portal_Scene3ToScene4");
	Scene3Portal2->SetPos(1960.f, 810.f);


	// 와일드 카고를 추가한다
	CTauroMasis* tauroMasis = CreateObject<CTauroMasis>("TauroMasis1");
	tauroMasis->SetPos(Vector2(200, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis2");
	tauroMasis->SetPos(Vector2(300, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis3");
	tauroMasis->SetPos(Vector2(400, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis4");
	tauroMasis->SetPos(Vector2(500, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis5");
	tauroMasis->SetPos(Vector2(600, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis6");
	tauroMasis->SetPos(Vector2(700, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis7");
	tauroMasis->SetPos(Vector2(800, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis8");
	tauroMasis->SetPos(Vector2(900, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis9");
	tauroMasis->SetPos(Vector2(1000, 500));
	tauroMasis->SetFallStartY(800.f);

	tauroMasis = CreateObject<CTauroMasis>("TauroMasis10");
	tauroMasis->SetPos(Vector2(1100, 500));
	tauroMasis->SetFallStartY(800.f);


	CTauroSpear* tauroSpear = CreateObject<CTauroSpear>("TauroSpear");
	tauroSpear->SetPos(Vector2(1000, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear1");
	tauroSpear->SetPos(Vector2(1000, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear2");
	tauroSpear->SetPos(Vector2(1100, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear3");
	tauroSpear->SetPos(Vector2(1200, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear4");
	tauroSpear->SetPos(Vector2(1300, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear5");
	tauroSpear->SetPos(Vector2(1400, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear6");
	tauroSpear->SetPos(Vector2(1500, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear7");
	tauroSpear->SetPos(Vector2(1600, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear8");
	tauroSpear->SetPos(Vector2(1700, 500));
	tauroSpear->SetFallStartY(800.f);

	tauroSpear = CreateObject<CTauroSpear>("TauroSpear9");
	tauroSpear->SetPos(Vector2(1800, 500));
	tauroSpear->SetFallStartY(800.f);
...
void CScene3::CreateAnimationSequence_Effect()
{
	// 플레이어 왼쪽->오른쪽 히트 이펙트 
...
void CScene3::CreateAnimationSequence1()
{
	std::vector<std::wstring>	vecFileName;
...
void CScene3::CreateAnimationSequence2()
{
	// 발록 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene3::CreateAnimationSequence3()
{
	// 타우로마시스 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene3::CreateAnimationSequence4()
{
	// 타우로스피어 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene3::CreateAnimationSequence5()
{
	// 와일드카고 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene3::CreateAnimationSequence6()
{
	// 포탈
	std::vector<std::wstring> vecFileName;
