...
#include "../GameObject/Scene1Back2.h"
#include "../GameObject/Scene1Back1.h"
...
bool CScene1::Init()
{
	...
	CreateAnimationSequenceMachine();

	// 채널 그룹을 BGM으로 하는 사운드 이름 MainBGM을 루프로 로드한다. 파일 명은 MainBgm.mp3 이다.
	GetSceneResource()->LoadSound("BGM", "Scene1BGM", true, "Maple/Back/GraveyardOfSword.mp3");
	
	GetSceneResource()->LoadSound("Effect", "MachineDeny", false, "Maple/Monster/Machine/Deny.mp3");
	GetSceneResource()->LoadSound("Effect", "MachineFailHit", false, "Maple/Monster/Machine/FailHit.mp3");
	GetSceneResource()->LoadSound("Effect", "MachineNormalHit", false, "Maple/Monster/Machine/NormalHit.mp3");
	GetSceneResource()->LoadSound("Effect", "MachineGoodHit", false, "Maple/Monster/Machine/GoodHit.mp3");
	...
	GetSceneResource()->SoundStop("Scene2BGM");
	GetSceneResource()->SoundStop("StartSceneBGM");
	GetSceneResource()->SoundPlay("Scene1BGM");
	...
	GetCamera()->SetWorldResolution(1049.f, 1035.f);  // 전체 크기
	...
	*/
	// 메인씬에 오브젝트(배경)을 추가한다.
	CScene1Back1* back1 = CreateObject<CScene1Back1>("Scene1Back1");
	CreateObject<CScene1Back2>("Scene1Back2");


	// 씬에 바닥 선을 추가한다.
	CGround* ground = CreateObject<CGround>("Ground1");
	ground->SetInfo(Vector2(1.f, 255.f), Vector2(1042.f, 255.f));
	ground->SetType(ELineType::Ground);

	ground = CreateObject<CGround>("Ground2");
	ground->SetInfo(Vector2(1.f, 823.f), Vector2(1042.f, 823.f));
	ground->SetType(ELineType::Ground);


	// 벽 선을 추가한다.
	CWall* wall = CreateObject<CWall>("Wall1");
	wall->SetInfo(Vector2(1.f, 1.f), Vector2(1.f, 897.f));
	wall->SetType(ELineType::Wall);

	wall = CreateObject<CWall>("Wall2");
	wall->SetInfo(Vector2(1048.f, 1.f), Vector2(1048.f, 933.f));
	wall->SetType(ELineType::Wall);


	// 밧줄과 사다리를 추가한다.
	CLadder* ladder = CreateObject<CLadder>("Ladder1");
	ladder->SetInfo(Vector2(649.f, 255.f), Vector2(647.f, 732.f));
	...
	// Scene2로 가는 포탈을 추가한다.
	CPortal* scene1Portal1 = CreateObject<CPortal>("Portal_Scene1ToScene2");
	scene1Portal1->SetPos(810.f, 250.f);


	// 뽑기기계를 추가한다.
	CMachine* machine = CreateObject<CMachine>("Machine");
	machine->SetPos(100.f, 700.f);
	machine->SetFallStartY(750.f);

	//// npc를 추가한다.
	//CNpc* muyeong = CreateObject<CNpc>("Muyeong");
	//muyeong->SetPos(720.f, 822.f);

	return true;
}

void CScene1::CreateAnimationSequence_Effect()
{
	// 플레이어 왼쪽->오른쪽 히트 이펙트 
...
void CScene1::CreateAnimationSequence1()
{
	std::vector<std::wstring>	vecFileName;
...
void CScene1::CreateAnimationSequence2()
{
	// 발록 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene1::CreateAnimationSequence3()
{
	// 타우로마시스 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene1::CreateAnimationSequence4()
{
	// 타우로스피어 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene1::CreateAnimationSequence5()
{
	// 와일드카고 왼쪽 정지상태 
	std::vector<std::wstring> vecFileName;
...
void CScene1::CreateAnimationSequence6()
{
	// 포탈
	std::vector<std::wstring> vecFileName;
	...
	for(int i = 0; i<5; ++i)
	{
		...
		wsprintf(fileName, TEXT("Maple/Npc/Muyeong/gloomy.%d.bmp"), i);
	...
	for (int i = 0; i < 4; ++i)
	{
		...
		wsprintf(fileName, TEXT("Maple/Npc/Muyeong/say.%d.bmp"), i);
...

	{
		...
		wsprintf(fileName, TEXT("Maple/Npc/Muyeong/balloon1.bmp"));

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("MuyeongBalloon1"))
	{
		GetSceneResource()->CreateAnimationSequence("MuyeongBalloon1",
			"MuyeongBalloon1", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("MuyeongBalloon1", 0.f, 0.f,
			121.f, 61.f);

		GetSceneResource()->AddAnimationFramePivot("MuyeongBalloon1", 0.5f, 1.f);

		GetSceneResource()->SetColorKey("MuyeongBalloon1", 255, 0, 255);
	}
...

	{
		...
		wsprintf(fileName, TEXT("Maple/Npc/Muyeong/balloon2.bmp"));

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("MuyeongBalloon2"))
	{
		GetSceneResource()->CreateAnimationSequence("MuyeongBalloon2",
			"MuyeongBalloon2", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("MuyeongBalloon2", 0.f, 0.f,
			121.f, 61.f);

		GetSceneResource()->AddAnimationFramePivot("MuyeongBalloon2", 0.5f, 1.f);

		GetSceneResource()->SetColorKey("MuyeongBalloon2", 255, 0, 255);
	}
...

	{
		...
		wsprintf(fileName, TEXT("Maple/Npc/Store/balloon1.bmp"));

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("StoreBalloon1"))
	{
		GetSceneResource()->CreateAnimationSequence("StoreBalloon1",
			"StoreBalloon1", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("StoreBalloon1", 0.f, 0.f,
			121.f, 61.f);

		GetSceneResource()->AddAnimationFramePivot("StoreBalloon1", 0.5f, 1.f);

		GetSceneResource()->SetColorKey("StoreBalloon1", 255, 0, 255);
	}
...

	{
		...
		wsprintf(fileName, TEXT("Maple/Npc/Store/balloon2.bmp"));

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("StoreBalloon2"))
	{
		GetSceneResource()->CreateAnimationSequence("StoreBalloon2",
			"StoreBalloon2", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("StoreBalloon2", 0.f, 0.f,
			121.f, 61.f);

		GetSceneResource()->AddAnimationFramePivot("StoreBalloon2", 0.5f, 1.f);

		GetSceneResource()->SetColorKey("StoreBalloon2", 255, 0, 255);
	}
	...
	for (int i = 0; i < 6; ++i)
	{
		...
		wsprintf(fileName, TEXT("Maple/Object/HPPotion/HPPotion.%d.bmp"), i);

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("HPPotion"))
	{
		GetSceneResource()->CreateAnimationSequence("HPPotion",
			"HPPotion", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("HPPotion", 0.f, 0.f,
			25.f, 25.f);
		GetSceneResource()->AddAnimationFrame("HPPotion", 0.f, 0.f,
			25.f, 25.f);
		GetSceneResource()->AddAnimationFrame("HPPotion", 0.f, 0.f,
		...
		GetSceneResource()->AddAnimationFramePivot("HPPotion", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("HPPotion", 0.5f, 0.6f);
		GetSceneResource()->AddAnimationFramePivot("HPPotion", 0.5f, 0.7f);
		GetSceneResource()->AddAnimationFramePivot("HPPotion", 0.5f, 0.8f);
		GetSceneResource()->AddAnimationFramePivot("HPPotion", 0.5f, 0.7f);
		GetSceneResource()->AddAnimationFramePivot("HPPotion", 0.5f, 0.6f);

		GetSceneResource()->SetColorKey("HPPotion", 255, 0, 255);
	}
	...
	for (int i = 0; i < 6; ++i)
	{
		...
		wsprintf(fileName, TEXT("Maple/Object/MPPotion/MPPotion.%d.bmp"), i);

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("MPPotion"))
	{
		GetSceneResource()->CreateAnimationSequence("MPPotion",
			"MPPotion", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("MPPotion", 0.f, 0.f,
			25.f, 25.f);
		GetSceneResource()->AddAnimationFrame("MPPotion", 0.f, 0.f,
			25.f, 25.f);
		GetSceneResource()->AddAnimationFrame("MPPotion", 0.f, 0.f,
		...
		GetSceneResource()->AddAnimationFramePivot("MPPotion", 0.5f, 0.5f);
		GetSceneResource()->AddAnimationFramePivot("MPPotion", 0.5f, 0.6f);
		GetSceneResource()->AddAnimationFramePivot("MPPotion", 0.5f, 0.7f);
		GetSceneResource()->AddAnimationFramePivot("MPPotion", 0.5f, 0.8f);
		GetSceneResource()->AddAnimationFramePivot("MPPotion", 0.5f, 0.7f);
		GetSceneResource()->AddAnimationFramePivot("MPPotion", 0.5f, 0.6f);

		GetSceneResource()->SetColorKey("MPPotion", 255, 0, 255);
	}
}

void CScene1::CreateAnimationSequenceMachine()
{
	// 기계 정지
	std::vector<std::wstring> vecFileName;
	...
	for (int i = 0; i < 16; ++i)
	{
		...
		wsprintf(fileName, TEXT("Maple/Monster/Machine/Stand/stand.%d.bmp"), i);

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("MachineStand"))
	{
		GetSceneResource()->CreateAnimationSequence("MachineStand",
			"MachineStand", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("MachineStand", 0.f, 0.f,
			226.f, 304.f);
		GetSceneResource()->AddAnimationFrame("MachineStand", 0.f, 0.f,
			226.f, 304.f);
		GetSceneResource()->AddAnimationFrame("MachineStand", 0.f, 0.f,
		...
		GetSceneResource()->AddAnimationFramePivot("MachineStand", 0.5f, 1.f);
		GetSceneResource()->AddAnimationFramePivot("MachineStand", 0.5f, 1.f);
		GetSceneResource()->AddAnimationFramePivot("MachineStand", 0.5f, 1.f);
		GetSceneResource()->AddAnimationFramePivot("MachineStand", 0.5f, 1.f);
		GetSceneResource()->AddAnimationFramePivot("MachineStand", 0.5f, 1.f);
		...
		GetSceneResource()->SetColorKey("MachineStand", 255, 0, 255);
	}
...

	{
		...
		wsprintf(fileName, TEXT("Maple/Monster/Machine/Hit/hit1.%d.bmp"), 0);

		vecFileName.push_back(fileName);
	}

	if (!GetSceneResource()->FindAnimation("MachineHit"))
	{
		GetSceneResource()->CreateAnimationSequence("MachineHit",
			"MachineHit", vecFileName, TEXTURE_PATH);

		GetSceneResource()->AddAnimationFrame("MachineHit", 0.f, 0.f,
			255.f, 347.f);

		GetSceneResource()->AddAnimationFramePivot("MachineHit", 0.56f, 1.f);

		GetSceneResource()->SetColorKey("MachineHit", 255, 0, 255);
	}
}
